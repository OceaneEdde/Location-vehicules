...
public class VehicleControllerAdvice {
    ...
    public VehicleControllerAdvice(MessageSource messageSource) {
        this.messageSource = messageSource;
    }

    /**
     * Appelée quand une exception métier liée aux radios/émissions survient.
     * Renvoie un 400 BAD_REQUEST avec le message métier.
     */
    @ExceptionHandler({VehicleException.class, TypeCarException.class, CarException.class})
