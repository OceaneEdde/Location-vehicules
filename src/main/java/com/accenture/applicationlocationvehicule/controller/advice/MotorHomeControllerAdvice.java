...
public class MotorHomeControllerAdvice {

    private final MessageSource messageSource;

    public MotorHomeControllerAdvice(MessageSource messageSource) {
        this.messageSource = messageSource;
    }

    @ExceptionHandler(MotorHomeException.class)
    public ResponseEntity<ErrorDto> businessException(MotorHomeException e) {
